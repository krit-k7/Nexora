...
const FeedbackPage = () => {
    ...
    switch(step) {
        ...
        return (
          ...
          >
            <div className="space-y-3">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-neutral-500/10 border border-neutral-500/20 rounded-full text-[10px] font-bold uppercase tracking-widest text-neutral-500">
                Phase_01
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <input 
                    ...
                    className="w-full px-5 py-4 bg-slate-50 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 rounded-2xl focus:ring-2 focus:ring-neutral-500 outline-none transition-all text-slate-900 dark:text-white placeholder:text-slate-400"
                    placeholder="Enter operator name"
                  />
                  <div className="absolute inset-0 rounded-2xl bg-neutral-500/5 opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity" />
                </div>
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input 
                    ...
                    onChange={handleInputChange}
                    className="w-full px-5 py-4 bg-slate-50 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 rounded-2xl focus:ring-2 focus:ring-neutral-500 outline-none transition-all text-slate-900 dark:text-white font-mono text-xs"
                    placeholder="G..."
                  />
                  {!wallet.address && (
            ...
            <button 
              ...
              className="w-full py-5 bg-neutral-600 hover:bg-neutral-500 disabled:opacity-30 disabled:cursor-not-allowed text-white rounded-2xl font-bold uppercase tracking-[0.2em] text-xs transition-all shadow-xl shadow-neutral-600/20 active:scale-[0.98]"
            >
      ...
      case 2:
        return (
          ...
          >
            <div className="space-y-3">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-neutral-500/10 border border-neutral-500/20 rounded-full text-[10px] font-bold uppercase tracking-widest text-neutral-400">
                Phase_02
              </div>
                ...
                <div className="flex justify-between gap-3">
                  {['1', '2', '3', '4', '5'].map(rating => (
                    <button
                      ...
                      className={`flex-1 py-4 rounded-2xl border font-bold transition-all ${formData.web3Experience === rating ? 'bg-neutral-600 border-neutral-500 text-white shadow-xl shadow-neutral-600/20 scale-105' : 'bg-slate-50 dark:bg-white/[0.03] border-slate-200 dark:border-white/10 text-slate-500 dark:text-slate-400 hover:border-neutral-500/50'}`}
                    >
                      {rating}
                    </button>
                  ))}
                ...
                <div className="grid grid-cols-3 gap-3">
                  {['Yes', 'No', 'Faced issues'].map(option => (
                    <button
                      ...
                      className={`py-4 rounded-2xl border text-[10px] font-bold uppercase tracking-wider transition-all ${formData.walletConnected === option ? 'bg-neutral-600 border-neutral-500 text-white shadow-xl shadow-neutral-600/20' : 'bg-slate-50 dark:bg-white/[0.03] border-slate-200 dark:border-white/10 text-slate-500 dark:text-slate-400 hover:border-neutral-500/50'}`}
                    >
                      {option}
                    </button>
                  ))}
                ...
                <div className="flex justify-between gap-3">
                  {['1', '2', '3', '4', '5'].map(rating => (
                    <button
                      ...
                      className={`flex-1 py-4 rounded-2xl border font-bold transition-all ${formData.onboardingEase === rating ? 'bg-neutral-600 border-neutral-500 text-white shadow-xl shadow-neutral-600/20 scale-105' : 'bg-slate-50 dark:bg-white/[0.03] border-slate-200 dark:border-white/10 text-slate-500 dark:text-slate-400 hover:border-neutral-500/50'}`}
                    >
                      {rating}
                    </button>
                  ))}
            ...
            <div className="flex gap-4">
              ...
              <button onClick={nextStep} className="flex-[2] py-5 bg-neutral-600 hover:bg-neutral-500 text-white rounded-2xl font-bold uppercase tracking-[0.2em] text-[10px] transition-all shadow-xl shadow-neutral-600/20">Proceed_</button>
            </div>
          </motion.div>
        );
      case 3:
          ...
          >
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  onChange={handleInputChange}
                  rows={2}
                  className="w-full px-5 py-4 bg-slate-50 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 rounded-2xl focus:ring-2 focus:ring-neutral-500 outline-none transition-all text-slate-900 dark:text-white placeholder:text-slate-500 text-xs"
            ...
            <div className="flex gap-4">
              ...
              <button 
                ...
                className="flex-[2] py-5 bg-neutral-600 hover:bg-neutral-500 text-white rounded-2xl font-bold uppercase tracking-[0.2em] text-[10px] transition-all shadow-xl shadow-neutral-600/20 disabled:opacity-30"
              >
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-zypher-bg text-white' : 'bg-slate-50 text-slate-900'} transition-colors duration-300 relative overflow-x-hidden`}>
      <Head>
        <title>Protocol Validation | Nexora Protocol</title>
        <meta name="description" content="Share your experience with Nexora Protocol and help us shape the future of Web3 automation." />
      </Head>

      {/* Decorative Background Elements */}
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-neutral-600/5 blur-[120px] rounded-full" />
        <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-neutral-600/5 blur-[120px] rounded-full" />
        ...
        <div className="w-full max-w-3xl">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-7xl font-bold tracking-tight leading-tight">
              Protocol <span className="text-transparent bg-clip-text bg-gradient-to-r from-neutral-600 to-neutral-500 dark:from-neutral-500 dark:to-neutral-400">Validation_</span>
            </h1>
                  ...
                  <div key={s.id} className="relative z-10 flex flex-col items-center gap-3 group">
                    <motion.div 
                      ...
                      animate={{ 
                        ...
                        borderColor: step >= s.id ? (step === s.id ? '#ffffff' : '#10b981') : (theme === 'dark' ? 'rgba(255,255,255,0.1)' : '#e2e8f0'),
                      }}
                    ...
                    <div className="flex flex-col items-center text-center">
                      <span className={`text-[8px] font-bold uppercase tracking-[0.2em] mb-1 ${step >= s.id ? 'text-neutral-500' : 'text-slate-500'}`}>Step_0{s.id}</span>
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-slate-500 dark:text-slate-400 text-lg max-w-md mx-auto">
                        Thank you for contributing to the Nexora Protocol. Your insights have been successfully recorded on the validation layer.
                      </p>
                    </div>
                    <div className="pt-8">
                      <button 
                        onClick={() => window.location.href = '/'}
                        className="px-12 py-5 bg-neutral-600 hover:bg-neutral-500 text-white rounded-2xl font-bold uppercase tracking-[0.2em] text-xs transition-all shadow-2xl shadow-neutral-600/30 active:scale-95"
                      >
                  ...
                  >
                    <div className="relative w-32 h-32">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <span className="text-2xl font-bold text-neutral-500">{transmissionProgress}%</span>
                      </div>
                    </div>
                    <div className="text-center space-y-4">
                      <h3 className="text-xl font-bold uppercase tracking-[0.3em] text-neutral-500 animate-pulse">Transmitting_Data...</h3>
