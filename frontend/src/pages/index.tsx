...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zypher-bg text-slate-900 dark:text-slate-200 selection:bg-neutral-500/30 overflow-x-hidden transition-colors duration-300">
      ...
      {/* Ambient Visual Orbs */}
      <div className="fixed top-[-10%] left-[-10%] w-[50%] h-[50%] bg-neutral-600/5 blur-[120px] rounded-full pointer-events-none" />
      <div className="fixed bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-neutral-600/5 blur-[120px] rounded-full pointer-events-none" />
      ...
      <main className="relative z-10 container mx-auto px-6 pt-24 pb-32 flex flex-col items-center">
        ...
        <motion.div
          ...
          className="mb-8 flex items-center gap-4 px-5 py-2 rounded-2xl border border-neutral-500/20 bg-neutral-500/5 backdrop-blur-md"
        >
          <div className="w-1.5 h-1.5 bg-neutral-400 rounded-full animate-pulse shadow-[0_0_10px_rgba(212, 212, 212,0.8)]" />
          <span className="text-[10px] font-bold text-neutral-500 dark:text-neutral-400 tracking-[0.1em] uppercase">Status: Protocol_Nominal_Alpha</span>
        </motion.div>
        ...
        >
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-slate-900 dark:text-white mb-6 leading-[1.1]">
            Define logic<span className="text-transparent bg-clip-text bg-gradient-to-r from-neutral-600 to-neutral-500 dark:from-neutral-500 dark:to-neutral-400"> →</span> verify<span className="text-transparent bg-clip-text bg-gradient-to-r from-neutral-600 to-neutral-500 dark:from-neutral-500 dark:to-neutral-400"> →</span><br />
            execute <span className="text-transparent bg-clip-text bg-gradient-to-r from-neutral-600 to-neutral-500 dark:from-neutral-500 dark:to-neutral-400">automatically.</span>
          </h1>
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 mb-12 max-w-xl mx-auto leading-relaxed font-medium">
            Nexora lets you write a simple rule, prove it on-chain, and trigger actions automatically — no middlemen, no oracles, no manual steps.
          </p>
          ...
          <div className="flex flex-col items-center gap-6 justify-center">
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-stretch">
              {wallet.address ? (
                  <Link 
                   ...
                   className="px-12 py-5 bg-slate-900 dark:bg-white text-white dark:text-slate-950 rounded-2xl font-bold text-[11px] uppercase tracking-wider shadow-2xl shadow-neutral-500/10 hover:bg-neutral-600 dark:hover:bg-neutral-600 hover:text-white dark:hover:text-white transition-all transform hover:-translate-y-1 flex items-center justify-center"
                  >
                ...
                <button 
                  onClick={() => connect()}
                  className="px-12 py-5 bg-neutral-600 text-white rounded-2xl font-bold text-[11px] uppercase tracking-wider shadow-2xl shadow-neutral-600/20 hover:bg-neutral-500 transition-all transform hover:-translate-y-1 active:scale-95 flex items-center justify-center"
                >
            ...
            {!wallet.address && (
              <a href="https://laboratory.stellar.org/#account-creator?network=test" target="_blank" rel="noreferrer" className="text-[10px] text-neutral-500 hover:text-neutral-400 font-bold uppercase tracking-widest transition-colors flex items-center gap-2 group">
                <span className="w-4 h-px bg-neutral-500/30 group-hover:w-6 transition-all" />
            ...
            {[
              ...
              <React.Fragment key={i}>
                <div className="flex flex-col items-center group w-32 sm:w-40">
                  <div className="w-16 h-16 rounded-[2rem] bg-neutral-500/10 border border-neutral-500/20 flex items-center justify-center text-2xl mb-4 group-hover:scale-110 transition-transform">
                    {s.icon}
                  </div>
                  <div className="text-[9px] font-bold uppercase tracking-widest text-neutral-500/60 mb-1">{s.step}</div>
                  <div className="flex flex-col items-center text-center min-h-[40px]">
                    ...
                    {s.action ? (
                      <a 
                        ...
                        target="_blank" 
                        rel="noreferrer"
                        className="text-[9px] font-bold text-neutral-500 hover:text-neutral-400 transition-colors uppercase tracking-wider whitespace-nowrap"
                      >
                        {s.action}
                      </a>
                    ) : (
        ...
        <motion.div 
          ...
          className="w-full max-w-6xl mb-32 p-1 bg-gradient-to-br from-neutral-500/20 via-transparent to-neutral-500/20 rounded-[3rem]"
        >
          <div className="bg-white/80 dark:bg-zypher-bg/80 backdrop-blur-3xl rounded-[2.9rem] p-12 border border-slate-200 dark:border-white/5 overflow-hidden relative">
             ...
             <div className="absolute inset-0 flex items-center justify-center opacity-10 pointer-events-none">
                <motion.div 
                  ...
                  className="w-[600px] h-[600px] border border-neutral-500 rounded-full"
                />
             </div>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl">
          {[
            ...
            <motion.div 
              ...
              className="p-10 rounded-[2.5rem] glass hover:border-neutral-500/30 transition-all group relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-24 h-24 bg-neutral-600/5 blur-3xl opacity-0 group-hover:opacity-100 transition-opacity" />
              <div className="w-14 h-14 bg-slate-100 dark:bg-white/5 rounded-2xl flex items-center justify-center mb-8 border border-slate-200 dark:border-white/10 group-hover:bg-neutral-600 group-hover:border-transparent transition-all">
                <svg className="w-6 h-6 text-neutral-500 dark:text-neutral-400 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="w-full max-w-6xl mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={idx} className="relative p-8 glass rounded-3xl border border-slate-200 dark:border-white/5 group hover:border-neutral-500/50 transition-all">
                <div className="text-4xl font-bold text-slate-200 dark:text-white/10 mb-4 group-hover:text-neutral-500/20 transition-colors">{s.step}</div>
        ...
        <div className="w-full max-w-6xl mt-32 p-12 bg-slate-50 dark:bg-white/5 rounded-[3rem] border border-slate-200 dark:border-white/10 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-96 h-96 bg-neutral-600/10 blur-[120px] rounded-full" />
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-8">
                <div>
                  <h4 className="text-neutral-600 dark:text-neutral-400 text-[10px] font-bold uppercase tracking-[0.1em] mb-2">Service_01</h4>
                  <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">ZK Prover Engine</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Nexora utilizes <strong>snarkjs</strong> and <strong>circom</strong> to generate Groth16 proofs. This ensures that your off-chain logic execution is verifiably correct before it ever touches the Stellar network.</p>
                </div>
                <div>
                  <h4 className="text-neutral-600 dark:text-neutral-400 text-[10px] font-bold uppercase tracking-[0.1em] mb-2">Service_02</h4>
            ...
            <div className="space-y-8 pt-20">
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Stop juggling multiple native tokens. Nexora abstracts gas costs through a unified deposit system, allowing you to pay for automation in stable credits.</p>
              </div>
              <div className="p-8 bg-gradient-to-br from-neutral-600/20 to-neutral-600/10 rounded-3xl border border-neutral-500/30 relative overflow-hidden group">
                <div className="absolute -top-10 -right-10 w-40 h-40 bg-neutral-500/10 blur-[60px] rounded-full group-hover:bg-neutral-500/20 transition-all" />
                ...
                <div className="bg-black/90 dark:bg-black/40 rounded-2xl p-5 mb-8 border border-white/5 font-mono text-[10px] relative">
                  ...
                  <div className="space-y-1">
                    <p className="text-neutral-400"><span className="text-neutral-400">import</span> {'{ Nexora }'} <span className="text-neutral-400">from</span> <span className="text-emerald-400">'@nexora/sdk'</span>;</p>
                    <p className="text-slate-300"><span className="text-neutral-400">const</span> client = <span className="text-neutral-400">new</span> <span className="text-neutral-400">Nexora</span>(<span className="text-emerald-400">'ZYPH-TEST-9F8A'</span>);</p>
                    <p className="text-slate-300"><span className="text-neutral-400">await</span> client.<span className="text-neutral-400">execute</span>(<span className="text-emerald-400">'LIQUIDATE_RULE'</span>, payload);</p>
                  </div>
                </div>

                <Link href="/docs/sdk" className="block w-full py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-950 rounded-xl text-[10px] font-bold uppercase tracking-wider hover:bg-neutral-600 dark:hover:bg-neutral-600 hover:text-white dark:hover:text-white transition-all shadow-xl shadow-neutral-500/10 text-center">
        ...
        <div className="w-full max-w-6xl mt-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-10 glass rounded-[2.5rem] border border-slate-200 dark:border-white/5">
              <div className="text-neutral-600 dark:text-neutral-500 font-bold text-6xl mb-6 opacity-20">DEV</div>
              ...
              <ul className="space-y-4 text-sm text-slate-600 dark:text-slate-400 mb-8">
                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-neutral-500 rounded-full" /> API Key Generation & Management</li>
                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-neutral-500 rounded-full" /> Webhook Integration Suite</li>
                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-neutral-500 rounded-full" /> Local Sandbox & Simulation Tools</li>
              </ul>
            </div>
            <div className="p-10 glass rounded-[2.5rem] border border-slate-200 dark:border-white/5">
              <div className="text-neutral-600 dark:text-neutral-500 font-bold text-6xl mb-6 opacity-20">NODE</div>
              <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Node Operator Hub</h3>
              <ul className="space-y-4 text-sm text-slate-600 dark:text-slate-400 mb-8">
                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-neutral-500 rounded-full" /> Real-time Network Telemetry</li>
                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-neutral-500 rounded-full" /> Verifier Node Health Monitoring</li>
                <li className="flex items-center gap-3"><div className="w-1.5 h-1.5 bg-neutral-500 rounded-full" /> Staking & Performance Metrics</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="glass p-8 rounded-[2rem] border border-slate-200 dark:border-white/5 hover:border-slate-300 dark:hover:border-white/20 transition-all flex flex-col">
                ...
                <button 
                  onClick={() => connect()}
                  className={`w-full py-4 rounded-xl text-[10px] font-bold uppercase tracking-[0.1em] transition-all ${idx === 2 ? 'bg-neutral-600 hover:bg-neutral-500 text-white' : 'bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-white/10 text-slate-600 dark:text-slate-300'}`}
                >
      ...
      <footer className="border-t border-slate-200 dark:border-white/[0.05] p-16 text-center">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 text-[10px] font-bold uppercase tracking-[0.15em] text-slate-500">
          <p>&copy; 2026 Nexora Protocol_</p>
          <div className="flex gap-8">
            <a href="#" className="hover:text-neutral-600 dark:hover:text-neutral-400 transition-colors">Twitter</a>
            <a href="#" className="hover:text-neutral-600 dark:hover:text-neutral-400 transition-colors">Stellar_Explorer</a>
            <a href="#" className="hover:text-neutral-600 dark:hover:text-neutral-400 transition-colors">Security_Audits</a>
          </div>
        </div>
      </footer>
    </div>
