        ...
        <main className="relative z-10 container mx-auto px-6 py-12">
          <header className="mb-16 border-b border-slate-200 dark:border-white/5 pb-12 flex flex-col md:flex-row justify-between items-end gap-8">
            <div>
              ...
              <p className="text-slate-500 font-medium tracking-tight">Real-time status of your Nexora verification engine.</p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-12">
                  ...
                  <div className="flex gap-2">
                    {[1,2,3,4,5,6].map(i => (
                      <motion.div 
                        ...
                        className="w-1 bg-neutral-500/40 rounded-full"
                      />
                    ))}
                  </div>
                </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="h-40 w-full bg-slate-100 dark:bg-black/20 rounded-[2rem] border border-slate-200 dark:border-white/5 flex items-end p-8 gap-2">
                    {Array.from({length: 40}).map((_, i) => (
                      <div 
                        key={i} 
                        className="flex-1 bg-neutral-500/20 rounded-t-sm group relative"
              ...
              <section className="p-10 rounded-[3.5rem] glass border-slate-200 dark:border-white/5">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div className="flex flex-col justify-center text-center p-8 bg-neutral-600/5 rounded-[3rem] border border-neutral-500/10">
                       <div className="text-[10px] font-bold text-neutral-600 dark:text-neutral-400 uppercase tracking-wider mb-4">Finality Score</div>
                       <div className="text-6xl font-bold text-slate-900 dark:text-white tracking-tighter mb-4">99.9<span className="text-neutral-600">8</span></div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="p-10 rounded-[3rem] glass border-slate-200 dark:border-white/5">
                  ...
                  <div className="flex justify-between items-center mb-8">
                    ...
                    <span className="text-lg font-bold text-neutral-600 dark:text-neutral-400 tracking-tight">142.5 ZYP</span>
                  </div>
                  <button 
                ...
                <div className="p-10 rounded-[3rem] glass border-emerald-500/10 bg-emerald-500/[0.02]">
                   ...
                   <div className="space-y-3">
                      <button className="w-full py-4 glass border-slate-200 dark:border-white/5 text-[9px] font-bold uppercase text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-all text-left px-6 flex items-center justify-between group">
                         ...
                         <div className="w-1.5 h-1.5 rounded-full bg-slate-300 dark:bg-white/20 group-hover:bg-neutral-500 transition-colors" />
                      </button>
                      <button className="w-full py-4 glass border-slate-200 dark:border-white/5 text-[9px] font-bold uppercase text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-all text-left px-6 flex items-center justify-between group">
            ...
            <aside className="space-y-8">
              ...
              <div className="p-10 rounded-[3rem] glass border-neutral-500/10 bg-neutral-600/[0.02]">
                 <h4 className="text-[10px] font-bold text-neutral-600 dark:text-neutral-400 uppercase tracking-wider mb-6">Validator Resources</h4>
                 <div className="space-y-4">
                    ...
                    <div className="p-4 bg-white dark:bg-black/20 rounded-2xl border border-slate-200 dark:border-white/5">
                       ...
                       <div className="text-neutral-600 dark:text-neutral-400 font-bold text-[10px]">1,242 VERIFIERS</div>
                    </div>
                 </div>
              </div>
            </aside>
