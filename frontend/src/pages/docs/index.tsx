...
const TechnicalDocs = () => {
  ...
  const coreConcepts = [
    {
      ...
      desc: 'How Nexora verifies off-chain events and commits them to the Stellar ledger with absolute cryptographic certainty.',
      tag: 'CORE'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-200 selection:bg-neutral-500/30 overflow-x-hidden">
      <Head>
        <title>Technical Documentation | Nexora Protocol</title>
        <meta name="description" content="Deep dive into the technical specifications, ZK architecture, and Soroban integration of the Nexora Protocol." />
      </Head>
      ...
      <main className="pt-32 pb-20 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-16">
        ...
        <aside className="hidden lg:block space-y-12 sticky top-32 h-fit">
          <div className="space-y-8">
            ...
            <div>
              ...
              <ul className="space-y-1">
                <li>
                  <Link href="/docs/sdk" className="flex items-center gap-3 p-3 rounded-2xl hover:bg-neutral-500/10 transition-all group border border-transparent hover:border-neutral-500/20">
                    <span className="text-lg">📦</span>
                    <span className="text-xs font-bold text-neutral-400 group-hover:text-neutral-300">TypeScript SDK</span>
                  </Link>
                </li>
                <li>
                  <a href="https://github.com/krit-k7/Nexora" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-2xl hover:bg-white/5 transition-all group">
                    <span className="text-lg">🐙</span>
          ...
          <div className="p-8 rounded-[2rem] bg-gradient-to-br from-neutral-600/10 to-neutral-600/5 border border-neutral-500/20 relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-24 h-24 bg-neutral-500/10 blur-3xl opacity-0 group-hover:opacity-100 transition-opacity" />
            <h5 className="text-[10px] font-bold text-neutral-400 uppercase mb-3 tracking-wider">Whitepaper_v1.2</h5>
            <p className="text-[10px] text-slate-400 leading-relaxed mb-6">Explore the full mathematical foundations of Nexora's ZK-Attestation model.</p>
        ...
        <div className="relative z-10">
          <motion.div
            ...
            className="mb-24"
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-500/30 bg-neutral-500/10 text-[10px] font-bold text-neutral-400 uppercase tracking-wider mb-6">
            ...
            <h1 className="text-7xl font-bold text-white tracking-tighter mb-8 leading-[0.85] uppercase">
              Technical<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-neutral-500 to-neutral-400">Documentation_</span>
            </h1>
            <p className="text-xl text-slate-400 leading-relaxed max-w-3xl">
              Nexora is a sovereign automation protocol built on the Stellar Network, utilizing Zero-Knowledge proofs to synchronize off-chain logic with on-chain state execution.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-32">
            {coreConcepts.map((c, i) => (
              <motion.div
                ...
                className="p-8 rounded-[2rem] glass border border-white/5 hover:border-neutral-500/30 transition-all group"
              >
                <div className="text-[9px] font-bold text-neutral-500 mb-3 tracking-[0.2em]">{c.tag}</div>
                <h3 className="text-lg font-bold text-white mb-3 group-hover:text-neutral-400 transition-colors">{c.title}</h3>
          ...
          <section id="architecture" className="scroll-mt-32 mb-32">
            <div className="flex items-center gap-4 mb-12">
              <div className="w-12 h-12 rounded-2xl bg-neutral-600/10 border border-neutral-500/20 flex items-center justify-center text-2xl">🏛️</div>
              <h2 className="text-4xl font-bold text-white tracking-tight uppercase">Network Architecture_</h2>
            </div>
            
            <div className="prose prose-invert max-w-none space-y-8">
              <p className="text-lg text-slate-400 leading-relaxed">
                The protocol operates as a decentralized verification layer. When a cross-chain event occurs (e.g., a transaction on Ethereum or a price change via an oracle), Nexora verifiers capture the state and generate a cryptographic attestation.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
                <div className="space-y-6">
                  ...
                  <ul className="space-y-3 text-sm text-slate-500">
                    <li className="flex items-start gap-3"><span className="text-neutral-500">→</span> Millisecond latency for event capture</li>
                    <li className="flex items-start gap-3"><span className="text-neutral-500">→</span> Multi-sig consensus for validator ingress</li>
                    <li className="flex items-start gap-3"><span className="text-neutral-500">→</span> End-to-end encrypted telemetry streams</li>
                  </ul>
                </div>
                <div className="aspect-video bg-neutral-600/5 border border-white/5 rounded-3xl p-8 flex items-center justify-center relative overflow-hidden group">
                  <div className="absolute inset-0 bg-gradient-to-br from-neutral-500/10 to-neutral-500/10 animate-pulse" />
                  <div className="relative z-10 text-center">
                    <div className="text-[10px] font-bold text-neutral-400 mb-2 tracking-wider uppercase">Visualizer_01</div>
          ...
          <section id="zk-proofs" className="scroll-mt-32 mb-32">
            <div className="flex items-center gap-4 mb-12">
              <div className="w-12 h-12 rounded-2xl bg-neutral-600/10 border border-neutral-500/20 flex items-center justify-center text-2xl">🧩</div>
              <h2 className="text-4xl font-bold text-white tracking-tight uppercase">ZK-Proof Systems_</h2>
            </div>
            
            <p className="text-lg text-slate-400 leading-relaxed mb-12">
              Nexora leverages <strong>Groth16</strong> Zero-Knowledge Succinct Non-Interactive Arguments of Knowledge (zk-SNARKs) to prove that logic rules were executed correctly without exposing the underlying private data.
            </p>
          ...
          <section id="topology" className="scroll-mt-32 mb-32">
            ...
            <div className="p-12 glass rounded-[3rem] border border-white/5 relative overflow-hidden">
               <div className="absolute -top-20 -right-20 w-80 h-80 bg-neutral-600/10 blur-[100px] rounded-full" />
               <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16">
                  <div>
                    ...
                    <p className="text-sm text-slate-400 leading-relaxed mb-8">
                      Nexora utilizes a globally distributed network of "Edge Verifiers" that sit closer to the data sources (Exchanges, Blockchains, IoT Gateways).
                    </p>
                    <div className="space-y-4">
                       <div className="flex items-center justify-between text-[10px] uppercase font-bold text-slate-500">
                          <span>Nodes Online</span>
                          <span className="text-neutral-400">1,248</span>
                       </div>
                       ...
                       {[
                         ...
                         <li key={idx} className="flex items-center justify-between p-4 rounded-2xl bg-white/5 border border-white/5">
                            ...
                            <div className="flex items-center gap-4">
                               <span className="text-[10px] font-bold text-neutral-500 uppercase">{n.status}</span>
      ...
      <section className="border-t border-white/[0.05] py-32 text-center mt-20 relative overflow-hidden">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-full bg-neutral-600/5 blur-[120px] rounded-full pointer-events-none" />
        <div className="relative z-10 max-w-2xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
             <Link href="/dashboard" className="px-10 py-4 bg-neutral-600 hover:bg-neutral-500 text-white rounded-2xl font-bold text-[10px] uppercase tracking-wider transition-all shadow-xl shadow-neutral-500/20">Protocol Dashboard</Link>
      ...
      <footer className="border-t border-white/[0.05] py-16 text-center text-[10px] font-bold uppercase tracking-[0.2em] text-slate-600">
        &copy; 2026 Nexora Research_ // Distributed under the Sovereign License_
      </footer>
    </div>
  );
};
