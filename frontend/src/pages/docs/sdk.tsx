...
const SdkDocs = () => {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-200 selection:bg-neutral-500/30">
      <Head>
        <title>SDK Documentation | Nexora Protocol</title>
        <meta name="description" content="Integrate the Nexora Protocol into your dApp with our lightweight, sovereign TypeScript SDK." />
      </Head>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/[0.05] bg-black/20 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="w-8 h-8 bg-neutral-600 rounded-lg flex items-center justify-center font-bold text-white text-xl group-hover:rotate-12 transition-transform">⬡</div>
            <span className="font-bold tracking-tight text-xl uppercase">Nexora<span className="text-neutral-500">_SDK</span></span>
          </Link>
          <div className="flex items-center gap-8 text-[10px] font-bold uppercase tracking-wider">
            <a href="https://github.com/krit-k7/Nexora" target="_blank" rel="noopener noreferrer" className="hover:text-neutral-400 transition-colors">GitHub</a>
            <Link href="/" className="px-5 py-2.5 bg-white text-slate-950 rounded-lg hover:bg-neutral-500 hover:text-white transition-all">Protocol Home</Link>
          </div>
        </div>
      </nav>
      ...
      <main className="pt-32 pb-20 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-16">
        ...
        <aside className="hidden lg:block space-y-8 sticky top-32 h-fit">
          ...
          <div className="p-6 rounded-2xl bg-neutral-500/5 border border-neutral-500/10">
            <h5 className="text-[10px] font-bold text-neutral-400 uppercase mb-2">Need Help?</h5>
            ...
            <button className="text-[10px] font-bold text-white uppercase underline decoration-neutral-500/50 hover:decoration-neutral-500 transition-all">Join Discord</button>
          </div>
        </aside>
        ...
        <article className="space-y-24">
          ...
          <section>
            ...
            <p className="text-xl text-slate-400 leading-relaxed max-w-2xl">
              The Nexora SDK is a lightweight, zero-dependency TypeScript library designed to embed trustless cross-chain automation directly into your application frontend or backend.
            </p>
          </section>
          ...
          <section id="install" className="scroll-mt-32">
            ...
            <div className="bg-black/40 rounded-3xl p-8 border border-white/5 relative group">
              ...
              <pre className="font-mono text-sm overflow-x-auto text-neutral-300">
                <code>npm install @nexora/sdk</code>
              </pre>
          ...
          <section id="quickstart" className="scroll-mt-32">
            ...
            <div className="bg-black/40 rounded-3xl p-8 border border-white/5 relative overflow-hidden">
              ...
              <pre className="font-mono text-sm leading-relaxed overflow-x-auto">
                <code>
                  <span className="text-neutral-400">import</span> {'{ NexoraSDK }'} <span className="text-neutral-400">from</span> <span className="text-emerald-400">'@nexora/sdk'</span>;<br /><br />
                  <span className="text-slate-500">// 1. Initialize Client</span><br />
                  <span className="text-neutral-400">const</span> sdk = <span className="text-neutral-400">new</span> <span className="text-neutral-400">NexoraSDK</span>({'{'}<br />
                  ...
                  <span className="text-neutral-400">const</span> result = <span className="text-neutral-400">await</span> sdk.rules.<span className="text-neutral-400">execute</span>(<span className="text-emerald-400">'rule_id_123'</span>);<br />
                  <span className="text-neutral-400">console</span>.<span className="text-neutral-400">log</span>(<span className="text-emerald-400">`Status: $</span>{'{result.status}'}<span className="text-emerald-400">`</span>);
                </code>
              </pre>
            </div>
          </section>
          ...
          <section id="rules" className="scroll-mt-32">
            ...
            <div className="bg-black/40 rounded-3xl p-8 border border-white/5 relative overflow-hidden">
              ...
              <pre className="font-mono text-sm leading-relaxed overflow-x-auto">
                <code>
                  <span className="text-neutral-400">await</span> sdk.rules.<span className="text-neutral-400">deploy</span>({'{'}<br />
          ...
          <section id="proofs" className="scroll-mt-32">
            ...
            <p className="text-slate-400 mb-8 leading-relaxed">Nexora uses Groth16 proofs to ensure that off-chain computations are verifiably correct without revealing sensitive data.</p>
            <div className="bg-black/40 rounded-3xl p-8 border border-white/5 relative overflow-hidden">
              <div className="absolute top-4 right-6 text-[10px] font-mono text-slate-500 uppercase tracking-wider">Verification</div>
              <pre className="font-mono text-sm leading-relaxed overflow-x-auto">
                <code>
                  <span className="text-neutral-400">const</span> isValid = <span className="text-neutral-400">await</span> sdk.proofs.<span className="text-neutral-400">verify</span>(proofId);<br />
                  <span className="text-neutral-400">if</span> (isValid) {'{'}<br />
                  &nbsp;&nbsp;<span className="text-neutral-400">console</span>.<span className="text-neutral-400">log</span>(<span className="text-emerald-400">'Proof cryptographically verified.'</span>);<br />
                  {'}'}
                </code>
              </pre>
            </div>
          ...
          <section className="pt-20 border-t border-white/5">
            <h2 className="text-[10px] font-bold uppercase tracking-[0.2em] text-neutral-500 mb-12">Core_Module_Reference</h2>
            <div className="space-y-12">
              {[
                ...
                <div key={m.name} className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-8 rounded-3xl hover:bg-white/[0.02] transition-all border border-transparent hover:border-white/5">
                  <code className="text-neutral-400 font-bold text-lg">{m.name}</code>
      ...
      <footer className="border-t border-white/[0.05] py-16 text-center mt-40">
        ...
        <div className="flex justify-center gap-8 text-[10px] font-bold text-slate-500 uppercase">
          ...
          <a href="#" className="hover:text-neutral-500 transition-colors">Stellar Docs</a>
          <a href="#" className="hover:text-neutral-500 transition-colors">Security</a>
        </div>
      </footer>
    </div>
  );
