        ...
        <main className="relative z-10 container mx-auto px-6 py-12 max-w-4xl">
          <header className="mb-16">
            <div className="flex items-center gap-4 mb-6">
              <span className="px-3 py-1 bg-neutral-500/10 text-neutral-600 dark:text-neutral-500 rounded-lg text-[9px] font-bold uppercase tracking-wider border border-neutral-500/20">Identity_Management</span>
            ...
            <div className="space-y-8">
              <div className="p-8 rounded-[3rem] glass border-slate-200 dark:border-white/5 flex flex-col items-center text-center">
                <div className="relative mb-6">
                  <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-neutral-500/20 bg-slate-100 dark:bg-black/40">
                    <img 
            ...
            <div className="md:col-span-2">
              <form onSubmit={handleSave} className="p-12 rounded-[3.5rem] glass border-slate-200 dark:border-white/5 space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    ...
                    <input 
                      ...
                      className="w-full px-6 py-4 bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-white/5 rounded-2xl text-sm font-medium text-slate-900 dark:text-white focus:border-neutral-500/50 outline-none transition-all placeholder:text-slate-400 dark:placeholder:text-slate-700"
                    />
                  </div>
                  <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <textarea 
                    ...
                    className="w-full px-6 py-4 bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-white/5 rounded-2xl text-sm font-medium text-slate-900 dark:text-white focus:border-neutral-500/50 outline-none transition-all placeholder:text-slate-400 dark:placeholder:text-slate-700 resize-none"
                  />
                </div>
                ...
                <div className="pt-6">
                  <button 
                    ...
                    onMouseEnter={playHover}
                    onClick={() => playClick()}
                    className="px-12 py-5 bg-neutral-600 hover:bg-neutral-500 text-white rounded-2xl font-bold text-[11px] uppercase tracking-[0.2em] shadow-2xl shadow-neutral-600/20 transition-all transform hover:-translate-y-1 active:scale-95 disabled:opacity-50 disabled:transform-none"
                  >
              ...
              <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                 <div className="p-8 rounded-[2.5rem] glass border-slate-200 dark:border-white/5 flex items-center justify-between group">
                    ...
                    <button className="px-5 py-2 bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-transparent rounded-xl text-[9px] font-bold uppercase text-slate-500 group-hover:bg-neutral-600 dark:group-hover:bg-neutral-500 group-hover:text-white transition-all">Verify</button>
                 </div>
                 <div className="p-8 rounded-[2.5rem] glass border-slate-200 dark:border-white/5 flex items-center justify-between group">
                    <div>
