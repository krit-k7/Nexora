        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md">
          ...
          >
            ...
            <div className="mb-6 relative z-10 text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-neutral-500/30 bg-neutral-500/10 text-[9px] font-bold text-neutral-400 uppercase tracking-wider mb-4">
                ...
                <button
                  ...
                  className={`w-full p-4 rounded-2xl border text-left flex justify-between items-center transition-all ${
                    selectedRole === role.id 
                      ? 'bg-neutral-600/10 border-neutral-500/50 text-slate-900 dark:text-white ring-1 ring-neutral-500/20' 
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center border transition-all ${
                      selectedRole === role.id ? 'bg-neutral-600 text-white border-neutral-400 shadow-[0_0_15px_rgba(37,99,235,0.3)]' : 'bg-slate-100 dark:bg-white/5 border-slate-200 dark:border-white/10 text-slate-500'
                    }`}>
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {selectedRole === role.id && (
                    <motion.div 
                      ...
                      className="w-2 h-2 rounded-full bg-neutral-600 shadow-[0_0_12px_rgba(37,99,235,0.6)]" 
                    />
                  )}
                </button>
              ))}
