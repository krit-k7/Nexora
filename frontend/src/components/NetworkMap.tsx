  ...
  return (
    <div className="relative w-full h-[550px] glass border-white/5 rounded-[2.5rem] overflow-hidden flex flex-col items-center justify-between pt-12 pb-8 px-4 md:px-12">
      ...
      <div className="flex justify-between w-full relative z-10 px-4 md:px-24">
         {[
           { name: 'Ethereum', icon: 'Ξ', color: 'text-neutral-400' },
           { name: 'Arbitrum', icon: 'A', color: 'text-neutral-400' },
           { name: 'Base', icon: 'B', color: 'text-neutral-500' }
         ].map((chain, i) => (
           <motion.div 
             key={i}
             animate={{ y: [0, -5, 0] }}
           ...
           >
              <div className="w-14 h-14 glass-premium border-white/10 rounded-2xl flex items-center justify-center text-xl font-bold group-hover:border-neutral-500/50 transition-all shadow-2xl">
      ...
      {/* Center: Nexora Core & Interchain Bridges */}
         ...
         <div className="relative z-20 flex flex-col items-center gap-6">
            <div className="relative">
               <motion.div 
                ...
                className="absolute inset-[-40px] border border-neutral-500/10 rounded-full border-dashed"
               />
               <motion.div 
                animate={{ scale: [1, 1.05, 1] }}
                transition={{ duration: 5, repeat: Infinity }}
                className="w-32 h-32 bg-neutral-600 rounded-[3rem] flex items-center justify-center text-white shadow-[0_0_100px_rgba(37,99,235,0.25)] border border-neutral-400/50 relative z-10"
               >
            ...
            <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-neutral-400 bg-neutral-500/5 px-8 py-2 rounded-full border border-neutral-500/10 shadow-2xl backdrop-blur-md">INTERCHAIN_V2_ORCHESTRATOR</span>
         </div>
      </div>

      {/* Bottom: Stellar Finality Layer */}
      <div className="relative z-10 flex flex-col items-center gap-4">
         <div className="h-8 md:h-12 w-[1px] bg-gradient-to-b from-neutral-500/30 to-transparent" />
         <motion.div 
           animate={{ y: [0, 5, 0] }}
