    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-4 mb-6">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-neutral-500 to-neutral-600 flex items-center justify-center text-white text-xl font-bold shadow-lg shadow-neutral-500/20 animate-float">
      ...
      <div className="absolute top-0 right-0 w-32 h-32 bg-neutral-500/5 blur-3xl -mr-16 -mt-16 group-hover:bg-neutral-500/10 transition-colors" />
    </motion.div>
  );
};
